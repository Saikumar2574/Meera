      ...
      <ul className="max-w-2xl mx-auto w-full grid grid-cols-1 md:grid-cols-2 items-start gap-4">
        {cards.map((card, index) => (
          <motion.div
            ...
            className="relative overflow-hidden bg-white rounded-lg shadow-lg group cursor-pointer"
          >
...
const cards = [
  {
    ...
    content: () => (
      <p>
        This winter jacket is perfect for keeping your boy warm during the
        colder months. Made from high-quality materials, it offers both comfort
        and style.
      </p>
    ),
    ctaText: "Buy Now",
