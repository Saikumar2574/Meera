        ...
        <div className="w-full h-full flex flex-col relative ml-0">
          <section className="h-full pt-10">
            ...
            >
              ...
              {/* <button
                onClick={() => router.back()}
                className="border-2 border-black px-4 py-2 font-bold rounded-xl hover:bg-black hover:text-white flex justify-center items-center gap-2"
              >
            ...
            <div className="relative">
              {/* <Carousel opts={{ align: "start" }} className="w-full">
                  <CarouselContent>
                    {products?.map((card, index) => (
                      <CarouselItem
                        key={index}
                        className={`basis-[50%] mt-10 relative group ${
                          cardStyle === 1
                            ? "basis-1/2"
                            : cardStyle === 2
                            ? "basis-[75%]"
                      ...
                      >
                        ...
                        <div className="absolute -top-10 left-16 hidden group-hover:flex bg-gray-800 text-white text-sm rounded-md py-2 px-4 z-50 shadow-lg">
                          ...
                          <div className="flex items-center justify-center gap-2">
                            <p className="text-lg italic font-bold">70%</p>
                            <p className="text-sm font-bold">Store Match</p>
                          </div>
                        </div>
                      </CarouselItem>
                    ))}
              ...
              <div className="grid grid-cols-2 md:grid-cols-4  gap-5 md:gap-10">
                {products?.partial_match?.map((card, index) => (
                  <div key={index} className="relative group">
                    <ProductCard card={card} />
                  </div>
                ))}
